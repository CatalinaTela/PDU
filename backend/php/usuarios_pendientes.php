...
// Guardar en la tabla de usuarios_pendientes
$guardar_usuario = conexion();
$guardar_usuario = $guardar_usuario->prepare("INSERT INTO usuarios_pendientes (name, lastname, mail, password, phone, token) VALUES (:nombre, :apellido, :email, :clave, :telefono, :token)");
